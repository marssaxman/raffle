...
public:
	...
	virtual void token_paren_left(location) override;
	virtual void token_paren_right(location) override;
	virtual void token_bracket_pair(location) override;
	virtual void token_bracket_left(location) override;
	virtual void token_bracket_right(location) override;
	virtual void token_brace_pair(location) override;
	virtual void token_brace_left(location) override;
	virtual void token_brace_right(location) override;
	...
	virtual void token_angle_left(location) override;
	virtual void token_angle_right(location) override;
	virtual void token_bang_equal(location) override;
	virtual void token_bang_angle_left(location) override;
	virtual void token_bang_angle_right(location) override;
