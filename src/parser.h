...
public:
	...
	struct error {
		virtual void parser_unexpected(lexer::position) = 0;
		virtual void parser_missing_operand(lexer::position) = 0;
		virtual void parser_mismatched_paren(lexer::position) = 0;
		virtual void parser_mismatched_bracket(lexer::position) = 0;
		virtual void parser_mismatched_brace(lexer::position) = 0;
		virtual void parser_unimplemented(lexer::position) = 0;
	};
	...
	virtual void token_blank(lexer::position p) override;
